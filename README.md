# Performance plots archive 2026

![GitHub repo size](https://img.shields.io/github/repo-size/segmentlinking/lst-performance-plots-archive-2026)
...
Plots from CI runs prior to 2026 can be found [here](https://github.com/SegmentLinking/TrackLooper-plots-archive/tree/main). The plots produced by the CI in [SegmentLinking/TrackLooper](https://github.com/SegmentLinking/TrackLooper) can be found in [here](https://github.com/SegmentLinking/TrackLooper-plots-archive/tree/main).
